...
_Define these in your Vercel project settings:_

- `VITE_API_URL` (e.g., `https://studysmart-backend.onrender.com`)

### Backend (Render)

_Define these in your Render Web Service settings:_
...
_(Note: Do not put real values in this document. Keep them secure in your hosting dashboard)._
...
_(Note: Vercel inherently supports SPA routing for Vite out-of-the-box via `vercel.json` or automatic configuration)._
