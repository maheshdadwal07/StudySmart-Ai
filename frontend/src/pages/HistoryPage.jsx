    ...
    <>
      ...
      <div className="panel">
        ...
        >
          <div style={{ display: "flex", gap: "8px" }}>
            <button
              ...
              style={{
                ...
                border: "none",
                backgroundColor:
                  filter === "all" ? "var(--text)" : "var(--surface-hover)",
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                backgroundColor:
                  filter === "study" ? "var(--text)" : "var(--surface-hover)",
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                backgroundColor:
                  filter === "quiz" ? "var(--text)" : "var(--surface-hover)",
          ...
          <div
            className="input-wrap history-search"
        ...
        {error ? (
          <div style={{ padding: "60px 20px", textAlign: "center" }}>
            ...
            <Button onClick={() => fetchHistory(page, filter, search)}>
              Retry
            </Button>
          </div>
          ...
          >
              ...
              {search
                ...
                : filter === "study"
                  ...
                  : filter === "quiz"
                    ...
                    : "No study or quiz sessions yet."}
            </h3>
            <p style={{ color: "var(--text-muted)", marginBottom: "24px" }}>
              {!search && filter !== "all"
                ? `Start generating ${filter} sessions to see them here.`
            ...
            {!search && (
              ...
              >
                <Button
                  variant={filter === "quiz" ? "secondary" : "primary"}
                  onClick={() => navigate("/uploads")}
                >
                  Start Studying
                </Button>
                <Button
                  variant={filter === "study" ? "secondary" : "primary"}
                  onClick={() => navigate("/question-mode")}
                >
                  Generate a Quiz
                </Button>
              </div>
              ...
              >
                <thead>
                  ...
                  >
                    ...
                    <th
                      className="history-table-date"
                      style={{ padding: "16px 20px", fontWeight: 600 }}
                    >
                      Date
                    </th>
                    <th
