...
const PIPELINE_NODES = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path d="M6 3h9l5 5v13a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1z" strokeWidth="1.7" strokeLinejoin="round" />
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path d="M12 2l2.2 5.2L20 9l-5.8 1.8L12 16l-2.2-5.2L4 9l5.8-1.8L12 2z" strokeWidth="1.6" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path d="M4 6h16M4 12h10M4 18h13" strokeWidth="1.7" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        ...
        <path d="M9.2 9.5a2.8 2.8 0 115.4.9c-.2.7-.7 1.1-1.2 1.5-.5.4-.9.7-1 1.3M12 16.5h.01" strokeWidth="1.6" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    <header className="hero">
      <div className="wrap hero-content">
        <span className="eyebrow">
          <span className="dot"></span>Now generating over 2M study questions a month
        </span>
        <h1>
          Turn Any Document Into <span className="grad">Smart Notes</span> &amp; AI‑Generated Questions
        </h1>
        ...
        <div className="hero-ctas">
          ...
          <a href="#" className="btn btn-secondary btn-lg">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M10 9l5 3-5 3V9z" fill="#111827" />
            </svg>
            Watch Demo
          </a>
        </div>
          ...
          <div className="pipeline-row">
            {PIPELINE_NODES.map((node, i) => (
              <React.Fragment key={node.label}>
                ...
                {i < PIPELINE_NODES.length - 1 && <div className="pconnector"></div>}
              </React.Fragment>
            ))}
          </div>
          <p className="pipeline-caption">
            Watch it happen live: <b>a single upload</b> becomes a full study kit in under 30 seconds.
          </p>
        </div>
      </div>
    </header>
